...
module.exports = class extends PickupRepository {
    ...
    async getById(id) {
        ...
        response.data['neighborhood'] = new Pickup(mongoResult.id, mongoResult.name, mongoResult.reference, mongoResult.nameLinkPerson, mongoResult.phones, mongoResult.status);
